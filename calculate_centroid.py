...
def main():
    parser = argparse.ArgumentParser(description='Calculate centroids from geoshape files')

    # args
    parser.add_argument('data_dir', required=True, help='path of geoshape files')
    parser.add_argument('output_dir', required=True, help='path to save centroid geoshape files')
    parser.add_argument('rows', default=100, help='Number of rows to count per geoshape file')
